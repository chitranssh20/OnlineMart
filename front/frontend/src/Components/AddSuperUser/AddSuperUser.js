...
export const AddSuperUser = () => {
    ...
    const submitStaffDetails = (e) =>{
        ...
        if (password!==confirmPassword){
            ...
            if (email==null || email == ''){
                ...
                axiosInstance.post('customer/addSuperuser/', staffDataForm).then((res)=>{
                        if (res.data.status === 302){
                            ...
                            window.alert('Super User has been added')
                        }
  ...
  return (
    ...
    <label htmlFor='email' >Email:</label>
        ...
        <br></br>
        <button type='submit' onClick={(e)=>submitStaffDetails(e)} >Add Super User</button>
    </form>
        </>
  )
}
